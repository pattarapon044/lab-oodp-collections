...
public class Customer {
	...
	/**
	 * Eats from the top of the stack of pancakes until either full or there's no
	 * pancakes left.
	 *
	 * If full, then the method returns successfully. If not, a HungryException is
	 * thrown.
	 *
	 * @param pancakes
	 */
	public void eat(Deque<Pancake> pancakes) throws HungryException {
		...
		/*
		 * While this customer wants to eat more pancakes - Get the top pancake of the
		 * stack (LIFO) - If we got a pancake: - Print out a message saying [customer
		 * name] ate [pancake.toString()]! - Decrease the amount of pancakes we want to
		 * eat by one - else: - Throw a HungryException If we make it to the end without
		 * throwing an exception, print out how many pancakes we ate.
		 */
